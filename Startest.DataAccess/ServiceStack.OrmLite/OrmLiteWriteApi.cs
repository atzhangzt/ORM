...
namespace ServiceStack.OrmLite
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(OrmLiteWriteApi));
        /// <summary>
        ...
        public static void InsertOrUpdate<T>(this IDbConnection dbConn,T obj)
        {
        ...
        /// <returns></returns>
        public static long InsertOrUpdateAll<T>(this IDbConnection dbConn, IEnumerable<T> lstObj)
        {
